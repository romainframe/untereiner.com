<template>
  <div class="content-wrapper bg-background-primary font-sans text-copy-primary leading-normal flex flex-col min-h-screen" :class="theme">
    <header class="border-t-14 border-royalblue-500">
      <nav class="container mx-auto flex flex-wrap justify-between items-center py-8">
        <div>
          <g-link v-if="theme === 'theme-light'" to="/"><div class="pl-4 font-bold text-copy-primary leading-tight">untereiner.com</div></g-link>
          <g-link v-else to="/"><div class="pl-4 font-bold text-copy-primary leading-tight">untereiner.com</div></g-link>
    ...
    <footer class="mt-5 bg-royalblue-500 text-white">
      <div class="container mx-auto flex flex-col lg:flex-row items-center justify-between py-8">
        <div class="pl-4 mb-8 lg:mb-0">
